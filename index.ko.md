...
타인을 배척하는 RMS의 의견과 행보에 대한 관용의 시간은 충분히 길었습니다. 우리는 우리가 그간 해 온 노력이 한 사람의 행동으로 인해 망가지는 꼴을 더는 용납할 수 없습니다. 더는 RMS와 같은 사람이 우리 사이에 설 자리가 없습니다. 이에 우리는 다시는 RMS와 같은 사람들의 행동으로 인해 고통받지 않을 것이며, RMS와 같은 사람들에게 리더직을 맡기지 않을 것이며, 다른 어떤 식으로든 RMS와 그의 해롭고 위험한 사상을 용인하지 않을 것입니다.
